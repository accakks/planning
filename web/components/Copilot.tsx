...
import { UserProfile, Theme, Task, ChatMessage, Category, Story, ChatSession } from '@shared/types';
import { chatWithCopilot } from '@shared/services/gemini';
import { getChatSessions, saveChatSession, deleteChatSession, createNewSession, generateSessionTitle } from '@shared/services/chatHistory';
